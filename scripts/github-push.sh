...
# ============================================================
# Erstellt einen temporären Branch ohne Entwicklungsartefakte
# und pusht diesen als main nach GitHub.
# Lokaler main-Branch und DevBox bleiben unberührt.
# ============================================================
set -euo pipefail
...
if ! git diff --quiet || ! git diff --cached --quiet; then
    echo "Fehler: Es gibt uncommittete Änderungen. Zuerst committen."
    exit 1
fi
